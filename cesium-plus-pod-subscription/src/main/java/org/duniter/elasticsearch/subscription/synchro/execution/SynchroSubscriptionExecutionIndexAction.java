package org.duniter.elasticsearch.subscription.synchro.execution;
...
public class SynchroSubscriptionExecutionIndexAction extends AbstractSynchroSubscriptionAction {
    ...
    public SynchroSubscriptionExecutionIndexAction(Duniter4jClient client,
        ...
        super(SubscriptionIndexDao.INDEX, SubscriptionExecutionDao.TYPE, client, pluginSettings,
